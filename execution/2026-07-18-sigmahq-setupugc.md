...
- 2026-07-18: Added a concise `Overview` section at the top of [PR #6152](https://github.com/SigmaHQ/sigma/pull/6152). It explains the signed-binary proxy-execution risk, the two covered modes, the normal-parent exclusions, and that local linting/validation passed.
